...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        for ind in range(n):
            random_item = XX[np.random.randint(0,n-1)]
            samples.append(random_item[:-1])
            labels.append(random_item[-1])
    ...
    def fitting(self):
        ...
        for i in range(self.num_trees):
            ...
            decision_tree.learn(self.bootstraps_datasets[i], self.bootstraps_labels[i])
        pass      
